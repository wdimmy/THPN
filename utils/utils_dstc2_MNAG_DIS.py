...
def prepare_data_seq(task, batch_size=100, shuffle=True):
    # test sample
    file_train = 'data/dstc2/dstc2trn.txt'
    file_dev = 'data/dstc2/dstc2dev.txt'
    file_test = 'data/dstc2/dstc2tst.txt'
    ent = entityList(
        'data/dstc2/dstc2-kb.txt', task)
    ...
    pair_dev, max_len_dev, max_r_dev, max_ir_ans_dev = read_langs(file_test, qa_dict, ent, max_line=None)
